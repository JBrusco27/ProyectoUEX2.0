...
<!-- Logica de profile -->
<script src="<?php echo $raiz; ?>Frontend/Components/ProfileComp/profile_comp.js"></script>
...
<header>
    ...
    <nav class="nav-container">
        ...
        <div class="nav-elements" id="nav-element-index"><a href="<?php echo $raiz; ?>index.php" class="HeadTrad1"></a></div>
        <div class="nav-elements" id="nav-element-contact"><a href="<?php echo $raiz; ?>Frontend/Contact/contact.php" class="HeadTrad2"></a></div>
        <div class="nav-elements" id="nav-element-schedules"><a href="<?php echo $raiz; ?>Frontend/Schedules/schedules.php" class="HeadTrad3"></a></div>
        <div class="nav-elements" id="nav-element-aboutus"><a href="<?php echo $raiz; ?>Frontend/AboutUs/aboutUs.php" class="HeadTrad4"></a></div>
    </nav>
    <!-- Navegación -->
    ...
    <section class="preferences-dropdown-container">
        <div class="preferences-dropdown-content" id="preferences-dropdown-content">
            <div class="preferences-dropdown-content-view" id="preferences-dropdown-content-view">
                <img class="preferences-dropdown-profile-img" src="<?php echo $raiz; ?>Frontend/Resources/guest.png" alt="">
