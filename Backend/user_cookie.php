...
session_start();
    ...
    {
        $tipo_usuario = intval($_SESSION['tipo_usuario']); // Asignar el valor de la cookie a la variable $nombre_usuario
    ...
    {
        $tipo_usuario = 1; // Asignar el valor de la cookie a la variable $nombre_usuario
    ...
    echo json_encode(['nombre_usuario'=>$nombre_usuario, 'email_usuario'=>$email_usuario, 'phone_usuario'=>$phone_usuario, 'tipo_usuario'=>$tipo_usuario]);
